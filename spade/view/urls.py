...
urlpatterns = patterns('',
    ...
    url(r'^site/(?P<site_id>\d+)/ua/$', 'spade.view.views.site_ua_report', name='site_ua_report'),
    url(r'^site/(?P<site_id>\d+)/css/$', 'spade.view.views.site_css_report', name='site_css_report'),
